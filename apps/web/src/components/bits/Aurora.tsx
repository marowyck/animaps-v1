...
/** Soft WebGL aurora (React Bits / ogl). Prefer lightMode + brand pastels for cozy pages. */
export default function Aurora({
  colorStops = ["#e07a96", "#5faf6a", "#f8d9e4"],
  amplitude = 0.85,
  blend = 0.65,
  speed = 0.55,
  lightMode = true,
  ...
  }, [amplitude, blend, lightMode, reduced, colorStops]);
